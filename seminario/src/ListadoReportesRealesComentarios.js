...
export default function ListadoReportesRealesComentarios({ navigation }) {
    ...
    const getReports = async () => {
        try {
            ...
            const response = await fetch(Route + 'listadoReportesRealesComentario',
                {
                    method: 'POST',
                    headers: {
                    ...
                    <View style={{ paddingTop: 20, paddingLeft: 20, paddingRight: 20, justifyContent: 'center' }}>
                        <View style={{ flexDirection: 'column', height: '7%' }}>
                            <View style={{ flexDirection: 'row', width: '100%', marginBottom: 5, marginTop: 20 }}>
                                ...
                                <Text style={{ fontSize: 30, fontWeight: 'bold', color: '#000', }}>Reportes de Comentario</Text>
                            </View>
                        </View>
