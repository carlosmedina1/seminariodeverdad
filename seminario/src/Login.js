...
export default function App({ navigation }) {
    ...
    const obtenerid = async (user) => {
        ...
        console.log(JSON.stringify(await data[0].es_admin))
        _storeSession(JSON.stringify(await data[0].nombre_usuario))

    }
    const _storeSession = async (nombrex) => {
        try {
            ...
            <View style={styles.container}>
                ...
                <View style={styles.body}>
                    ...
                    <View style={styles.action}>
                        ...
                        <TextInput placeholder="Correo electronico" style={{ marginBottom: 10, width: '100%' }} onChangeText={(text) => setUser(text)} />
                    </View>
