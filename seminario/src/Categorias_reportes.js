...
export default function Categorias_reportes({ navigation }) {
    return (
                        ...
                        <View style={{ backgroundColor: "white", height: '100%' }}>
                            ...
                            <ScrollView contentContainerStyle={styles.contentContainer} >
                                <View style={{ marginLeft: 10 }}>
                                    <TouchableOpacity onPress={() => navigation.navigate("ListadoReporteProductos")}>
                                        <Image
                                ...
                                <View style={{ marginLeft: 10, }}>
                                    <TouchableOpacity onPress={() => navigation.navigate("ListadoReporteComentarios")}>
                                        <Image
                                            style={styles.imgPersonas}
