                        ...
                        <View style={{ backgroundColor: "white", height: '100%' }}>
                            ...
                            <ScrollView contentContainerStyle={styles.contentContainer} >
                                <View style={{ marginLeft: 10 }}>
                                    <TouchableOpacity onPress={() => navigation.navigate("CrearSubcategoria", { cat: 1 })}>
                                        <Image
                                ...
                                <View style={{ marginLeft: 10, }}>
                                    <TouchableOpacity onPress={() => navigation.navigate("CrearSubcategoria", { cat: 2})}>
                                        <Image
                                            style={styles.imgPersonas}
                                ...
                                <View style={{ marginLeft: 10 }}>
                                    <TouchableOpacity onPress={() => navigation.navigate("CrearSubcategoria", { cat: 3})}>
                                        <Image
                                            style={styles.imgPersonas}
                                ...
                                <View style={{ marginLeft: 10 }}>
                                    <TouchableOpacity onPress={() => navigation.navigate("CrearSubcategoria", { cat: 4})}>
                                        <Image
                                            style={styles.imgPersonas}
                                ...
                                <View style={{ marginLeft: 10 }}>
                                    <TouchableOpacity onPress={() => navigation.navigate("CrearSubcategoria", { cat: 5})}>
                                        <Image
                                            style={styles.imgPersonas}
                                ...
                                <View style={{ marginLeft: 10 }}>
                                    <TouchableOpacity onPress={() => navigation.navigate("CrearSubcategoria", { cat: 6})}>
                                        <Image
                                            style={styles.imgPersonas}
