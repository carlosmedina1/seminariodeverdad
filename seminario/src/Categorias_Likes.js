                ...
                <View style={styles.card}>
                    <View style={{ paddingTop: 20, paddingLeft: 20, paddingRight: 20, justifyContent: 'center', marginTop: 50 }}>
                        <View style={{ flexDirection: 'row', width: '100%', marginBottom: 5, }}>
                            ...
                            <Text style={{ fontSize: 30, fontWeight: 'bold', color: '#000', }}>Selecciona el tipo de Likes</Text>
                        </View>
                        <View style={{ backgroundColor: "white", height: '100%' }}>
                            ...
                            <ScrollView contentContainerStyle={styles.contentContainer} >
                                <View style={{ marginLeft: 10 }}>
                                    <TouchableOpacity onPress={() => navigation.navigate("ListadoLikesProductos")}>
                                        <Image
                                ...
                                <View style={{ marginLeft: 10, }}>
                                    <TouchableOpacity onPress={() => navigation.navigate("ListadoLikesComentarios")}>
                                        <Image
                                            style={styles.imgPersonas}
