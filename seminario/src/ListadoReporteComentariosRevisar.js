                                                    ...
                                                    <TouchableOpacity style={styles.itemContainer}  onPress={() => goLista(item)}>
                                                        <View style={{ flexDirection: 'row', width: '100%' }}>
                                                            <View style={{ flexDirection: 'column', marginTop: 10, width: '100%' }}>
                                                                <Text style={{ flex: 15, fontSize: 30, fontWeight: 'bold', color: '#000' }}>{item.comentario} </Text>
                                                                <Text style={{ flex: 15, fontSize: 17, fontWeight: 'bold', color: '#000', marginTop: 6 }}>En producto: {item.nombre_producto}</Text>
